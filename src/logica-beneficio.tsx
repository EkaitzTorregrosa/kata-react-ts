var ganancias: any = {};
export function datosMercancia(
  kgVieiras: number,
  kgPulpo: number,
  kgCentollo: number
) {
  var precioEstimadoMadrid =
    calcularPrecio("vieira", kgVieiras, "madrid") +
    calcularPrecio("pulpo", kgPulpo, "madrid") +
    calcularPrecio("centollo", kgCentollo, "madrid");

  var precioEstimadoBarcelona =
    calcularPrecio("vieira", kgVieiras, "barcelona") +
    calcularPrecio("pulpo", kgPulpo, "barcelona") +
    calcularPrecio("centollo", kgCentollo, "barcelona");

  var precioEstimadoLisboa =
    calcularPrecio("vieira", kgVieiras, "lisboa") +
    calcularPrecio("pulpo", kgPulpo, "lisboa") +
    calcularPrecio("centollo", kgCentollo, "lisboa");
